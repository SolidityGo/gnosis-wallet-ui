...
export function useQueryApproveInfo(gnosisProxyAddress: string, sortedOwners: string[], unsignedPayload: UnsignedTxPayload): UseQueryResult<QueryApproveInfoResult> {
  const gnosisSdk = useGnosisSdk(gnosisProxyAddress);
